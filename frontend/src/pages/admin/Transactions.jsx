...
export default function AdminTransactions() {
  ...
  const sortedOrders = [...filteredOrders].sort((a, b) => {
    ...
    switch (sortBy) {
      case 'date':
        comparison = new Date(b.purchaseDate || 0) - new Date(a.purchaseDate || 0)
        break
      case 'amount':
          ...
          <div className="flex flex-wrap gap-4 items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm font-medium hover:bg-gray-200 transition-all flex items-center gap-2"
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-t pt-4">
                    ...
                    <div className="text-2xl font-bold text-green-600">
                      ৳{selectedOrder.amount?.toFixed(0) || '0'}
                    </div>
                  </div>
                  ...
                  <div className="border-t pt-4">
                    <div className="text-sm text-gray-600 mb-2">Offer Number (Package Activation)</div>
                    <div className="text-sm text-gray-900 font-mono break-all">
                      {selectedOrder.offerNumber || 'N/A'}
                    </div>
                  </div>
